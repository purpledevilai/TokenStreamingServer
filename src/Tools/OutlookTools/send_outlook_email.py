...
async def send_outlook_email_func_async(integration_id: str, to: str, subject: str, body: str, html: bool = False) -> str:
    loop = asyncio.get_event_loop()
    return await loop.run_in_executor(
        None,
        lambda: send_outlook_email_func(integration_id, to, subject, body, html)
    )
